percent_agreement <- function(df, var1, var2) {
  # Calculates percent agreement of two categorical variables
  #
  # Args:
  #   df: a data frame containing the categorical variables for comparison
  ...
  percent_agreement <- round(mean(agreement) * 100, digits = 2)
