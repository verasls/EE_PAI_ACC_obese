...
LOOCV of the LMM was done with the `cross_validate_mixed_model` [function](https://github.com/verasls/EE_PAI_ACC_obese/blob/master/R/cross_validate_mixed_model.R) and is shown below.
...
LOOCV of the ROC curves was done with the `cross_validate_ROC_curves` [function](https://github.com/verasls/EE_PAI_ACC_obese/blob/master/R/cross_validate_ROC_curves.R) and is shown below.
